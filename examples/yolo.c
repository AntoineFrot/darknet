...
void run_yolo(int argc, char **argv)
{
    ...
    else if(0==strcmp(argv[2], "demo_camera")) demo_camera(cfg, weights, thresh, cam_index, filename, voc_names, 20, frame_skip, prefix, avg, .5, 0,0,0,0);
    else if(0==strcmp(argv[2], "demo_screencapture")) demo_screencapture(cfg, weights, thresh, cam_index, filename, voc_names, 20, frame_skip, prefix, avg, .5, 0,0,0,0);
}
